...
-- Ajouter la colonne is_deleted manquante
-- Ajouter la colonne is_deleted si elle nexiste pas
DO $$
BEGIN
    IF NOT EXISTS (
    ...
    ELSE
        RAISE NOTICELacolonne is_deleted existe déjà dans la table scheduled_tasks;
    END IF;
END
$$;
...
SELECTChamp is_deleted ajouté avec succès à la table scheduled_tasks!' as message;
